...
const NewItem = ({onAddItem}: {onAddItem: any}) => {
  ...
  return (
    <div className="flex justify-center rounded-sm bg-gray-800 mt-2 p-2">
      <form className="space-y-0.5" onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <button
            ...
            className={"flex rounded-sm bg-green-700 disabled:cursor-not-allowed disabled:bg-gray-500 px-19  mt-1"}
